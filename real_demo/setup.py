...
folders = ['ur5e_hande_mjx', 'walker_mjx', 'mj_planner', 'data', 'ik_based_planner', 'collision_free_ik',  
            'math_utils', 'MLP_projection' , 'mlp_proj_training_weights', 'sampling_based_planner']
